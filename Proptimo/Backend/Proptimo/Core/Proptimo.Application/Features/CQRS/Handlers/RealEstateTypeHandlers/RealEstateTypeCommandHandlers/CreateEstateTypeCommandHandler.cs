...
{
    public class CreateEstateTypeCommandHandler : IRequestHandler<CreateEstateTypeCommand>
    {
        ...
        public async Task Handle(CreateEstateTypeCommand request, CancellationToken cancellationToken)
        {
